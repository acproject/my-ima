error id: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqUserRepository.java
file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqUserRepository.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqUserRepository.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqUserRepository.java