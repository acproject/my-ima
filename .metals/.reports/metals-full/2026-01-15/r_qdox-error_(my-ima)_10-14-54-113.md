error id: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRealmRepository.java
file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRealmRepository.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRealmRepository.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRealmRepository.java