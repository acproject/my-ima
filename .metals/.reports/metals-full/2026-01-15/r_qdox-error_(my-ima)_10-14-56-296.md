error id: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRoleRepository.java
file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRoleRepository.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRoleRepository.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/owiseman/core/jooq/repository/impl/JooqRoleRepository.java